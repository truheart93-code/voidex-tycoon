...
const TUTORIAL_STEPS = [
  {
    id: 'buy_first',
    icon: '🪨',
    title: '1. Purchase Your First Generator',
    text: 'Click BUY on the Asteroid Mine. You have 25 credits and it costs 10. Let\'s start your empire.',
    arrowDir: 'down',
    tab: 'generators',
  ...
  },
  {
    id: 'tap_start',
    icon: '⚡',
    title: '2. Activate Your Generator',
    text: 'Tap the Asteroid Mine card to fire it up. The progress bar will start filling.',
    arrowDir: 'down',
    tab: 'generators',
  ...
  },
  {
    id: 'collect',
    icon: '💎',
    title: '3. Collect Your Earnings',
    text: 'When the progress bar fills and turns gold, tap it to collect. Those credits are yours.',
    arrowDir: 'down',
    tab: 'generators',
  ...
  },
  {
    id: 'crew_intro',
    icon: '👥',
    title: '4. Hire Your Crew',
    text: 'Tapping forever sounds exhausting. Tap the glowing CREW button below to hire managers who will run your generators automatically.',
    arrowDir: 'none',
  ...
  },
  {
    id: 'crew_explain',
    icon: '👥',
    title: '4. Crew Explained',
    text: 'Managers automate your generators. Once hired, they\'ll keep earning credits while you\'re away. Worth every credit.',
    arrowDir: 'none',
    tab: 'managers',
    autoAdvance: 3000,
  },
  {
    id: 'tech_intro',
    icon: '🔬',
    title: '5. Upgrade Your Tech',
    text: 'Now tap the glowing TECH button to see upgrades. These multiply your generator output.',
    arrowDir: 'none',
  ...
  },
  {
    id: 'tech_explain',
    icon: '🔬',
    title: '5. Tech Upgrades Explained',
    text: 'Upgrades boost your generator\'s power: 2x, 3x, even 10x output. Mathematically irresponsible. Financially brilliant.',
    arrowDir: 'none',
    tab: 'upgrades',
    autoAdvance: 3000,
  },
  {
    ...
    icon: '🚀',
    title: 'You\'re Ready!',
    text: 'Now go forth and build your empire. Tap, earn, upgrade, repeat. The galaxy is waiting, commander.',
    arrowDir: 'none',
    tab: 'generators',
    autoAdvance: 4000,
  },
